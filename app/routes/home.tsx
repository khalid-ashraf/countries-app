...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Asia Explorer" },
    { name: "description", content: "Welcome to your countries explorer!" },
  ];
}
          ...
          <div className='w-full md:w-1/2 md:px-3'>
            <div className='space-y-6 sm:max-w-md lg:max-w-lg'>
              ...
              <div className='flex flex-col sm:flex-row sm:space-x-4'>
                <Link
                  to='/countries'
                  className='flex items-center justify-center px-6 py-3 text-lg bg-indigo-600 rounded-md hover:bg-indigo-700'
                >
                  Explore Now
                  <svg
